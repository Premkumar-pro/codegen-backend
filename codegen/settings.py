...
# # Minimal static setting for admin
# STATIC_URL = "/static/"
...
#     "django.contrib.sessions",
#     "django.contrib.messages",
#     "django.contrib.staticfiles",  # needed for admin CSS
#     "rest_framework",
#     "corsheaders",
#     "social_django",
#     "users",
...
# ---------- CORS ----------
FRONTEND_URL = os.getenv("FRONTEND_URL", "https://codegen-mocha.vercel.app")
CORS_ALLOWED_ORIGINS = [FRONTEND_URL]
CORS_ALLOW_CREDENTIALS = True
CSRF_TRUSTED_ORIGINS = [FRONTEND_URL]
...
# ---------- Health Check ----------
# Add this to your codegen/urls.py:
